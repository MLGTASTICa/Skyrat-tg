...
/obj/item/rig_suit/proc/deploy(mob/living/M)
	equip_to_slot_if_possible(suit_pieces["GLOVES"], gloves, qdel_on_fail = FALSE, disable_warning = FALSE, redraw_mob = TRUE, bypass_equip_delay_self = TRUE, initial = FALSE)
	equip_to_slot_if_possible(suit_pieces["VEST"], suit, qdel_on_fail = FALSE, disable_warning = FALSE, redraw_mob = TRUE, bypass_equip_delay_self = TRUE, initial = FALSE)
	equip_to_slot_if_possible(suit_pieces["HELMET"], head, qdel_on_fail = FALSE, disable_warning = FALSE, redraw_mob = TRUE, bypass_equip_delay_self = TRUE, initial = FALSE)
	equip_to_slot_if_possible(suit_pieces["BOOTS"], shoes, qdel_on_fail = FALSE, disable_warning = FALSE, redraw_mob = TRUE, bypass_equip_delay_self = TRUE, initial = FALSE)
